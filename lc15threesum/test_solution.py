...
from lc15threesum.solution import Solution

class TestSolution(TestCase):
    def test_two_sum(self):
        solution = Solution()
        self.assertEqual(solution.twoSum([2,7,11,15], 9), [[2, 7]])
    ...
    def test_sol2(self):
        ...
        # self.assertEqual([[-1, -1, 2], [-1, 0, 1]], solution.sol2([-1, 0, 1, 2, -1, -4]))
        # self.assertEqual(solution.sol2([0, 1, 1]), [])
        # self.assertEqual(solution.sol2([0, 0, 0]), [[0, 0, 0]])
        self.assertEqual([[0, 0, 0]], solution.sol2([0, 0, 0, 0]))

        # got = solution.sol2([-1, 0, 1, 2, -1, -4, -2, -3, 3, 0, 4])
        # self.assertEqual(got, [[-4, 0, 4], [-4, 1, 3], [-3, -1, 4], [-3, 0, 3], [-3, 1, 2], [-2, -1, 3], [-2, 0, 2],
        #                        [-1, -1, 2], [-1, 0, 1]])
